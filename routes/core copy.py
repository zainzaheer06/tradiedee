...
from services.recording_service import audio_recorder as recording_service
...
def call_ended_webhook():
    ...
    try:
            ...
            try:
                ...
                if contact:
                    ...
                    if campaign:
                        ...
                        if recording_url:
                            logger.info(f"Recording URL received for campaign: {recording_url[:100]}...")
                        recording_id = None
        ...
        if call_log:
            ...
            recording_url = data.get('recording_url')
            if recording_url and call_log.status == 'completed':

...
class RecordingService:
    ...
    def upload_to_oss(self, file_path: str, oss_key: str):
        ...
        try:
            ...
            url = self.bucket.sign_url('GET', oss_key, 7 * 24 * 3600)
    ...
    async def process_recording(self, egress_id: str, room_name: str):
        ...
        try:
            ...
            # Generate signed URL for the OSS file (7 days expiry)
            oss_url = self.get_signed_url(oss_filepath, expires_in_days=7)
    ...
    def get_signed_url(self, oss_key: str, expires_in_days: int = 7):
        """
